...
/*Function that writes a caracter*/
void PutChar(char c);

/*Function that writes a string*/
void PutString(const char *s);

/*Functions that get the caracter*/
int GetChar(void);

/*Functions that get the whole caracters*/
char GetString(char *s, int n);

/* Function that writes a int */
void PutInt(int n);

/* Functions that get the integer */
void GetInt(int *n);

/* Functions that create a thread */
void ThreadCreate(int f, int arg);

/* Functions that exit a thread */
