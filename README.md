...
**Étudiant en Master 2 CSI (Cryptanalyse et Sécurité Informatique)** passionné par la sécurité des systèmes, la rétro-ingénierie (analyse de vulnérabilités) et l'architecture réseau.
